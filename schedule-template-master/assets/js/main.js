(function () {
	...
	function ScheduleTemplate(element) {
		...
		this.scheduleGroup = document.getElementsByClassName('cd-schedule__group');
		this.scheduleGroup[0].addEventListener('click', function (event) {
			event.preventDefault();

			var x = document.createElement("li");
			x.className = 'cd-schedule__event';
			x.innerHTML = '<a data-start="9:00" data-end="10:30"  data-content="event-yoga-1" data-event="event-3" href="#0"><em class="cd-schedule__name">Drawing</em></a>';
			document.getElementsByClassName('cd-schedule__list')[0].appendChild(x);
		});
		this.scheduleGroup[1].addEventListener('click', function (event) {
			event.preventDefault();

			var x = document.createElement("li");
			x.className = 'cd-schedule__event';
			x.innerHTML = '<a data-start="12:00" data-end="14:00"  data-content="event-yoga-1" data-event="event-3" href="#0"><em class="cd-schedule__name">Yoga</em></a>';
			document.getElementsByClassName('cd-schedule__list')[1].appendChild(x);
		});
		this.scheduleGroup[2].addEventListener('click', function (event) {
			event.preventDefault();

			var x = document.createElement("li");
			x.className = 'cd-schedule__event';
			x.innerHTML = '<a data-start="9:00" data-end="10:30"  data-content="event-yoga-1" data-event="event-3" href="#0"><em class="cd-schedule__name">Class</em></a>';
			document.getElementsByClassName('cd-schedule__list')[2].appendChild(x);
		});
		this.scheduleGroup[3].addEventListener('click', function (event) {
			event.preventDefault();

			var x = document.createElement("li");
			x.className = 'cd-schedule__event';
			x.innerHTML = '<a data-start="15:00" data-end="18:00"  data-content="event-yoga-1" data-event="event-3" href="#0"><em class="cd-schedule__name">Study</em></a>';
			document.getElementsByClassName('cd-schedule__list')[3].appendChild(x);
		});
